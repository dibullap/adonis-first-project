...
Route.group(() => {
  ...
  Route.get('/listar-usuario-grupos', 'UsuariosController.getListarUsuariosGrupos')
  ...
  Route.post('/registro-publicacion', 'PublicacionsController.setRegistroPublicacion')
